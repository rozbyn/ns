...
↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	- returnHtmlBeetweenIDs($BeginId, $EndId) - принимает два обязательных параметра ID первого элемента
	и ID последнего. Возвращает HTML код элементов ID которых находятся между этими двумя значениями,
