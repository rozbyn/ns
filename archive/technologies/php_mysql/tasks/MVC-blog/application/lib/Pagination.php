...
class Pagination {
    ...
    public function get() {
		...
		if (is_null($links)) {
			...
			$retArr['limit'] = $this->limit;
			$retArr['start'] = (int)($this->current_page-1) * $this->limit;
		}
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li class="page-item"><a class="page-link" href="'.$GLOBALS['bDir'].'/'.$this->route['controller'].'/'.$this->route['action'].'/'.$page.'">'.$text.'</a></li>';
    }
