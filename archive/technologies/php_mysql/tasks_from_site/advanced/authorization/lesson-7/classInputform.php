...
class Inputform {
	...
	public $formContent=[];
	public $validateLoginRegEx = '#(?!(?:^\d*$)|.{31})^[a-z0-9]{1}(?:[a-z0-9]|(?:[-](?!(?:-)|(?:_)))|(?:[_](?!(?:-)|(?:_))))+[a-z0-9]{1}$#i';
	...
	public function addCheckBox($tagName, $tags=[], $saveFormValue = false, $required = false, $htmlBefore='', $htmlAfter=''){
		$id = $this->setId();
		$this->formContent[$id]['tagName'] = $tagName;
